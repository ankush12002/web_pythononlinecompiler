...
document.getElementById("save_file").addEventListener("click",function(){var text=editor.getSession().getValue();var filename="js-code.js";download(filename,text)},!1);function unminifyjs($id){var codejs=document.getElementById($id).value;if(isJs(codejs)){code=js_beautify(codejs);codejs.value=code}else{document.getElementById("alertjavascript").innerHTML=`<div class="alert alert-danger alert-dismissible fade show" role="alert">
